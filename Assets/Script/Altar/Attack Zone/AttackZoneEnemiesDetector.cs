...
public class AttackZoneEnemiesDetector : MonoBehaviour, IStepsControllable
{
    ...
    public List<EnemyInterfaceObject> EnemiesInAttackZone { get; private set; } = new List<EnemyInterfaceObject>();
    ...
    {
        if (other.gameObject.TryGetComponent(out EnemyInterfaceObject enemyController) && !EnemiesInAttackZone.Contains(enemyController))
        {
